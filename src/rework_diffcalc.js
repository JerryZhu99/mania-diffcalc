  ...
  for (let i = 0; i < notes.length; i++) {
    ...
    if (currentNote.isLN) {
      ...
      if (lnLength < parameters.LN_SHORT_THRESHOLD) {
        ...
        strainBonus = ((1 - lnLength / parameters.LN_SHORT_THRESHOLD)) * parameters.LN_SHORT_BONUS;
        ...
        strainBonus = Math.min(1, t) * parameters.LN_LONG_BONUS;
      }
    }
    ...
    currentNote.strain = parameters.STRAIN_FACTOR * strain * (1 + strainBonus);
